    ...
    for fai_C in fai_list:
        ...
        #for f in [0.1, 0.5, 0.9, 0.95, 0.99]:
            ...
            if not isExists:
                ...
                os.chdir(folder_h)
            isHave1=os.path.exists('C:\Users\weijie\workspace2\DisHD\output\\'+folder_h+'\\objs.pickle')
            isHave2=os.path.exists('C:\Users\weijie\workspace2\DisHD\output\\'+folder_h+'\\objs2.pickle')
            #print (isHave)
